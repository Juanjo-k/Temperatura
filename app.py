...
def main():
    ...
    st.set_page_config(page_title="Conversor °C ↔ °F", page_icon="🌡️", layout="centered")
    ...
    try:
        ...
        with st.expander("Información técnica / Depuración"):
            st.write("Versión de Streamlit detectada:", st.__version__)
        ...
        st.caption("Hecho con ❤️ — asegúrate de que el archivo se llame app.py y no streamlit.py")
